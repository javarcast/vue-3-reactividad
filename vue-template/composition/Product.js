app.component("product", {
    ...
    setup(props, context){
        const productState = reactive({
            activeImage: 0,
            price_color: computed(()=> (props.product.stock > 1)? "rgb(104, 104, 209)": "rgb(188, 30 , 67)")
           // price_color: "rgb(104, 104, 209)"

        });

        const discountCodes= ref(["PLATZI20", "CODDIS"]);
        ...
        watch(()=>productState.activeImage, (val, oldValue)=>{ //se crear una funcion anonima pasandole el objeto a observar para que vue sabe que propiedad observar
